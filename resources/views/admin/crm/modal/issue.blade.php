                ...
                <div class="modal-body">
                    ...
                    <div class="modal-form container">
                        <div class="form-group row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <select class="form-select" id="inputType" name="type">
                                            ...
                                            <option value="8" @if($entry->type == 8) selected @endif>Rękojmia</option>
                                        </select>
                            ...
                            <div class="col-3">
                                <div class="row">
                                    <label for="inputDate" class="col-12 col-form-label control-label required mb-2 justify-content-start">Data zgłoszenia</label>
                                    <div class="col-12">
                                        <input type="text"
                                               value="{{$entry->start}}"
                            ...
                            <div class="col-3">
                                <div class="row">
                                    <label for="inputDeadline" class="col-12 col-form-label control-label required mb-2 justify-content-start">Termin</label>
                                    <div class="col-12">
                                        <input type="text"
                        ...
                        <div class="form-group row">
                            <div class="col-12">
                                <div class="row">
                                    <label for="inputTitle" class="col-12 col-form-label control-label required mb-2 justify-content-start">Nazwa zgłoszenia<span class="text-danger d-inline w-auto ps-1">*</span>
                                    </label>
                                    <div class="col-12">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div id="selectedClientItem">
                                            @if($entry->contact_id != 0)
                                                <div class="row">
                                                    <div class="col-12">
                                                        <h4>{{ $entry->client->name }} {{ $entry->client->lastname }}<button type="button" id="btn-confirm" class="btn btn-primary btn-sm action-button"><i class="las la-trash-alt"></i></button></h4>
                        ...
                        <div class="form-group row">
                            <div class="col-12">
                                <div class="row">
                                    <label for="inputNote" class="col-12 col-form-label control-label required mb-2 justify-content-start">Opis zgłoszenia</label>
                                    <div class="col-12">
    ...
    function initModal()
    {
        ...
        modalElement.addEventListener('shown.bs.modal', function () {
            ...
            inputDate.datepicker({
                ...
                $('#inputDeadline').val(formattedDeadline);
            });
            ...
            inputClient.typeahead({
                ...
                if (clientItem) {
                    clientItem.innerHTML = '<div class="row"><div class="col-12">' +
                        '<h4>' + suggestion.name + ' ' + suggestion.lastname + '<button type="button" id="btn-confirm" class="btn btn-primary btn-sm action-button"><i class="las la-trash-alt"></i></button></h4>' +
        ...
        form.addEventListener('submit', (e) => {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    'deadline': inputDeadline.val() !== 0 ? inputDeadline.val() : null,
