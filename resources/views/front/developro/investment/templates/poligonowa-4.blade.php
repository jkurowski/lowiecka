...
@section('content')
    <main>
        ...
        $slides = [
            [
                'title' => 'Apartamenty Poligonowa Etap 4',
                'subtitle' => 'Elegancja i komfort',
                'text' => 'Apartamenty Poligonowa Etap 4 to nowoczesna inwestycja w zielonej dzielnicy Sławin w Lublinie. W czterokondygnacyjnym budynku zaplanowano 94 funkcjonalne mieszkania o różnych metrażach, w tym apartamenty z antresolami. Projekt łączy nowoczesną architekturę, komfort życia i doskonałą lokalizację blisko miejskiej infrastruktury oraz terenów rekreacyjnych.',
                'button' => [
                    'text' => 'Apartamenty',
                    'link' => '#mieszkania',
                ],
                'image_url' => asset('images/w-sprzedazy/poligonowa-4/wiz-1.jpg'),
            ],
        ];
        ...
        <div data-bs-spy="scroll" data-bs-target="#investment-navbar">
                    ...
                    <div class="row align-items-center row-gap-50px">
                        <div class="col-12 col-md-6 col-lg-5">
                            <h2 class="h3 mb-40px">
                                ...
                                <span class="d-block text-uppercase" data-aos="fade-up">Poligonowa Etap 4</span>
                            </h2>
                            <div class="text-content fw-light" data-aos="fade">
                                <p>
                                    Apartamenty Poligonowa Etap 4 to nowoczesna inwestycja w zielonej dzielnicy Sławin w
                                    Lublinie. W czterokondygnacyjnym budynku zaplanowano 94 funkcjonalne mieszkania o
                                    różnych metrażach, w tym apartamenty z antresolami. Projekt łączy nowoczesną
                                    architekturę, komfort życia i doskonałą lokalizację blisko miejskiej infrastruktury oraz
                                    terenów rekreacyjnych.
                                </p>
                                <p>
                                    <strong>
                                        Zakończenie budowy: II kwartał 2026 r.
                                    </strong>
                                </p>
                            </div>
                                ...
                                <div class="slick-slider with-blurred-inactive "
                                    ...
                                    <div class="pb-2">
                                        <div class="rounded-1 overflow-hidden">
                                            <a href="{{ asset('images/w-sprzedazy/poligonowa-4/slider-wiz-full-1.jpg') }}"
                                                class='glightbox'>
                                                <img src="{{ asset('images/w-sprzedazy/poligonowa-4/slider-wiz-1.jpg') }}"
                                    ...
                                    <div class="pb-2">
                                        <div class="rounded-1 overflow-hidden">
                                            <a href="{{ asset('images/w-sprzedazy/poligonowa-4/slider-wiz-full-2.jpg') }}"
                                                class='glightbox'>
                                                <img src="{{ asset('images/w-sprzedazy/poligonowa-4/slider-wiz-2.jpg') }}"
                                                    alt="" width="555" height="512" loading="lazy">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="pb-2">
                                        <div class="rounded-1 overflow-hidden">
                                            <a href="{{ asset('images/w-sprzedazy/poligonowa-4/slider-wiz-full-3.jpg') }}"
                                                class='glightbox'>
                                                <img src="{{ asset('images/w-sprzedazy/poligonowa-4/slider-wiz-3.jpg') }}"
                                                    alt="" width="555" height="512" loading="lazy">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="pb-2">
                                        <div class="rounded-1 overflow-hidden">
                                            <a href="{{ asset('images/w-sprzedazy/poligonowa-4/slider-wiz-full-4.jpg') }}"
                                                class='glightbox'>
                                                <img src="{{ asset('images/w-sprzedazy/poligonowa-4/slider-wiz-4.jpg') }}"
                                                    alt="" width="555" height="512" loading="lazy">
                                            </a>
                                        </div>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-10 offset-lg-1">
                            <div class="stacking-content-md" >
                                ...
                                <div class="text-white col-12 col-lg-10 col-xl-9 align-content-end mx-auto mb-3 mb-lg-4 bg-black bg-md-transparent">
                                    <x-search-form-investment></x-search-form-investment>
                                </div>
                            </div>
                        </div>
            ...
            <section class="gradient-bg-wrapper padding-top-medium" id="atuty">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <h2 class="h3 mb-40px text-center pb-md-30px">
                                <span class="fw-thin d-block fs-4" data-aos="fade-up">Powody, dla których warto </span>
                                <span class="d-block text-uppercase" data-aos="fade-up">kupić mieszkanie dwupoziomowe</span>
                            </h2>
                        </div>
                    </div>
                </div>
                ...
                <div class="container pb-md-40px">
                    ...
                    $items = [
                        [
                            ...
                            'description' => 'zróżnicowany metraż apartamentów<br>od 34,49 m2 do 83,86 m2',
                        ],
                        [
                        ...
                        [
                            ...
                            'description' => 'mieszkania dwupoziomowe<br>– poczuj się jak w domu',
                        ],
                        [
                            'icon' => asset('images/hands.svg'),
                            'title' => 'Realizacja',
                            'description' => 'termin realizacji<br>to II kwartał 2026 r.',
                        ],
                    ]; ?>
            ...
            <section class="position-relative stacking-content align-items-center py-0 blur-left">
                <img src="{{ asset('images/w-sprzedazy/poligonowa-4/wiz-3.jpg') }}" alt="O firmie"
                ...
                <div class="container text-white section-padding-block-large">
                    <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                        <h2 class="h3 mb-40px">
                            <span class="fw-thin d-block fs-4" data-aos="fade-up">Apartamenty</span>
                            <span class="d-block text-uppercase" data-aos="fade-up">POLIGONOWA 4</span>
                        </h2>
                        <div class="text-content fw-light" data-aos="fade">
                            <p>
                                Apartamenty Poligonowa etap 4 to kontynuacja nowoczesnej inwestycji zlokalizowanej w
                                spokojnej i atrakcyjnej części Lublina – dzielnicy Sławin. Projekt zakłada budowę
                                4-kondygnacyjnego budynku, w którym powstaną 94 mieszkania o zróżnicowanych metrażach – od
                                kompaktowych kawalerek po przestronne czteropokojowe apartamenty. Na ostatnim piętrze
                                dostępne będą mieszkania z antresolami, idealne dla osób poszukujących nietuzinkowych
                                rozwiązań.
                            </p>
                            <p>
                                Każde mieszkanie zostało zaprojektowane z myślą o funkcjonalności i wygodzie. Duże
                                przeszklenia zapewniają naturalne doświetlenie wnętrz, a przemyślane rozkłady pomieszczeń
                                umożliwiają elastyczne podejście do aranżacji wnętrz. Inwestycja wyróżnia się nowoczesną
                                architekturą i starannie zaprojektowaną przestrzenią wokół budynku, oferując komfort życia w
                                otoczeniu zieleni.
                            </p>
                            <p>
                                Lokalizacja inwestycji zapewnia równowagę pomiędzy dynamiką miasta, a spokojem natury.
                                Bliskość głównych szlaków komunikacyjnych oraz terenów rekreacyjnych czyni projekt
                                atrakcyjnym zarówno dla osób aktywnych zawodowo, jak i rodzin poszukujących komfortowych
                                warunków życia.
                            </p>
                            <p>
                                <strong>
                                    Planowany termin realizacji to II kwartał 2026 r.
                                </strong>
                            </p>
                            <div class="text-center text-md-start">
            ...
            <div id="kontakt">
                <x-cta :investmentName="$investment->name" :investmentId="$investment->id" pageTitle="Opis inwestycji - Poligonowa 4" back="true"></x-cta>
            </div>
        </div>
    </main>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const CORDS = [51.271676, 22.526200];
            ...
            L.marker(CORDS, {
                icon: icon
            }).addTo(investmentMap).bindPopup('Apartamenty Poligonowa 4').openPopup();
        })
    </script>
@endsection
@push('scripts')
