                    ...
                    <div class="row">
                        <div class="col-12">
                            @foreach ($tagsArray as $tagName => $tagData)
                                @php
                                    $tagName = str_replace([' ', ': ', '.'], ['_', ':_', '_'], $tagName);
                                @endphp
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-4">
                                                <select class="form-select" id="{{ $placeholdersArray[$tagName]['placeholder'] }}[type]" name="{{ $placeholdersArray[$tagName]['placeholder'] }}[type]">
                                                    ...
                                                    <option value="client-name" @if(isset($placeholdersArray[$tagName]['type']) && $placeholdersArray[$tagName]['type'] === 'client-name') selected @endif>Klient: imię i nazwisko</option>

                                                    <option value="client-pesel" @if(isset($placeholdersArray[$tagName]['type']) && $placeholdersArray[$tagName]['type'] === 'client-pesel') selected @endif>Klient: PESEL</option>

                                                    <option value="client-id_number" @if(isset($placeholdersArray[$tagName]['type']) && $placeholdersArray[$tagName]['type'] === 'client-id_number') selected @endif>Klient: nr. dowodu</option>

                                                    <option value="client-email" @if(isset($placeholdersArray[$tagName]['type']) && $placeholdersArray[$tagName]['type'] === 'client-email') selected @endif>Klient: e-mail</option>

                                                    <option value="client-phone" @if(isset($placeholdersArray[$tagName]['type']) && $placeholdersArray[$tagName]['type'] === 'client-phone') selected @endif>Klient: telefon</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="row mt-3">
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-4">
                                                <select class="form-select" id="{{ $tagName }}[type]" name="{{ $tagName }}[type]">
                                                    ...
                                                    <option value="client-name">Klient: imię i nazwisko</option>
                                                    <option value="client-pesel">Klient: PESEL</option>
                                                    <option value="client-id_number">Klient: nr. dowodu</option>
                                                    <option value="client-email">Klient: e-mail</option>
                                                    <option value="client-phone">Klient: telefon</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="row mt-3">
