                                    ...
                                    <div class="col-7">
                                        <div class="input-group">
                                            <input type="text"
                                                   ...
                                                   id="inputPercent"
                                                   name="percent">
                                            <button class="btn btn-outline-secondary input-group-text" type="button" id="calc-percent"><i class="las la-calculator"></i></button>
                                        </div>
                                    ...
                                    <div class="col-7">
                                        <div class="input-group">
                                            <input type="text"
                                                   ...
                                                   id="inputAmount"
                                                   name="amount">
                                            <button class="btn btn-outline-secondary input-group-text" type="button" id="calc-amount"><i class="las la-calculator"></i></button>
                                        </div>
