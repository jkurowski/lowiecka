        ...
        <div class="card-header border-bottom card-nav">
            <nav class="nav">
                ...
                <a class="nav-link {{ Request::routeIs('admin.crm.offer.*') ? ' active' : '' }}"
                    ...
                    <a class="nav-link {{ Request::routeIs('admin.crm.offer.drafts') ? ' active' : '' }}"
                    href="{{ route('admin.crm.offer.drafts') }}"><span class="fe-file"></span>Szkice</a>
            </nav>
        </div>
                    ...
                    <table class="table data-table mb-0 w-100">
                        <thead class="thead-default">
                            <tr>
                                ...
                                <th>Telefon</th>
                                <th>Miasto</th>
                                <th class="colsearch">Handlowiec</th>
                                <th>Status</th>
                                <th>Dołączył</th>
                                <th></th>
                            </tr>
