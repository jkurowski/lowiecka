                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            @include('form-elements.html-input-file', ['label' => 'Plan piętra', 'sublabel' => '(wymiary: '.config('images.floor.plan_width').'px / '.config('images.floor.plan_height').'px)', 'name' => 'file'])
