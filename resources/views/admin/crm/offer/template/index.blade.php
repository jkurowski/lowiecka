            ...
            <div class="card-head container-fluid">
                <div class="row">
                    ...
                    <div class="col-6 d-flex justify-content-end align-items-center form-group-submit">
                        <a href="{{ route('admin.crm.offer.templates.create') }}" class="btn btn-primary">Nowy szablon</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="table-overflow">
                    <table class="table mb-0">
                        ...
                        <tr>
                            <th>Nazwa</th>
                            <th>Opis</th>
                            <th class="text-center">Inwestycja</th>
                        ...
                        @foreach($emailTemplates as $item)
                            <tr id="recordsArray_{{ $item->id }}">
                                ...
                                <td class="option-120">
                                    <div class="btn-group">
                                        <a href="{{ route('admin.crm.offer.templates.edit', ['id' => $item->id]) }}"
                                        ...
                                        <a href="{{ route('admin.crm.offer.templates.show', ['id' => $item->id]) }}"
                                           class="btn action-button me-1"
                                           data-bs-toggle="tooltip"
                                           data-placement="top"
                                           data-bs-title="Otwórz szablon"
                                           target="_blank">
                                            <i class="fe-file-text"></i>
                                        </a>
                                        <a href="{{ route('front.email-template-preview.show', ['id' => $item->id]) }}   "
                                        ...
                                        <form method="POST"
                                              action="{{ route('admin.crm.offer.templates.destroy', ['id' => $item->id]) }}">
                                            {{ csrf_field() }}
                                            {{ method_field('DELETE') }}
                                            <button type="submit"
