            ...
            <form action="" method="post" id="modalForm">
                ...
                <div class="modal-body">
                    ...
                    <div class="modal-form container">
                        <div class="row">
                            <div class="col-12">
                                @include('form-elements.modal.modal-select', ['label' => 'Kategoria', 'name' => 'category_id', 'selected' => $entry->category_id, 'select' => \App\Helpers\ContractorType::getStatusesForSelect()])
