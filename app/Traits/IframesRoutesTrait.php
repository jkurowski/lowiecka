...
trait IframesRoutesTrait
{
    ...
    public function getRouteForProperty(Investment $investment, Property $property)
    {
        ...
        switch ($investment->type) {
            case 1:
                return route('front.iframe.single.apartmentMultiBuilding', ['investment' => $investment->slug, 'building' => $property->building_id, 'floor' => $property->floor_id, 'property' => $property->id]);
