...
class AttachmentsList extends BaseBlock
{

    private string $view = 'email-templates-json-parser.blocks.attachments-list';

    public array $wrapperStyles = ['backgroundColor', 'textAlign', 'padding'];

    public string $type = BlockTypes::ATTACHMENTS_LIST;
