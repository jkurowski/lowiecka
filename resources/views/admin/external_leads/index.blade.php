                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-12 d-flex justify-content-end">
                            <div class="row">
                                <div class="col">
                                    <label for="form_source" class="form-label">Miejsce</label>
            ...
            $(document).ready(function() {
                const t = $('.data-table').DataTable({
                    ...
                    initComplete: function() {
                        ...
                        table.columns('.select-column').every(function() {
                            const column = this;
                            ...
                            defaultOption.value = '';
                            defaultOption.textContent = column.header().textContent;
                            ...
                            const uniqueValues = Array.from(column.data().toArray())
